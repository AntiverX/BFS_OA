"""
Django settings for BFS_OA project.
...
SECRET_KEY = 'cfnj_h3e_1oe_6lco+o8cqwb-0)v3&5hzywan)^5)f(9#%*3pc'
...
WSGI_APPLICATION = 'BFS_OA.wsgi.application'
